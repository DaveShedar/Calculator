...
public class Calculator {
    static void arabicDigits(char[] final_string){
         ...
         operate(digit1, digit2, operation);
     }

    static void romanDigit(char[] final_string){
        String operation = "";
        char tempOperation = ' ';
        String tempString1 = "";
        String tempString2 = "";
        ...
        operate(convertRomanToArabic(digit1), convertRomanToArabic(digit2), operation);
    }
    ...
    static int convertRomanToArabic(String x){
        if (!x.equals("I") && !x.equals("V") && !x.equals("X")&& !x.equals("IX")
            ...
            switch (x) {
                ...
                case "IX": return 9;
                case "X": return 10;
//            default: return -789456;
            }
        }
        throw new RuntimeException();
    }

    static void operate(double digit1, double digit2, String operation){
        if(operation.equals("+")){
